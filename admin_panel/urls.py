...
urlpatterns = [
    ...
    path('branches/edit_branch/<slug:slug>/', edit_branch, name='edit_branch'),
    ...
    path('bookings/complete/<int:id>', complete_booking, name="complete_booking"),
    ...
    path('customer_queries/resolve/<int:id>', resolved_queries, name="resolved_queries"),
    ...
    path('manage_site/delete_review/<int:id>', delete_review, name="delete_review"),
