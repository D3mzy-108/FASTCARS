...
urlpatterns = [
    ...
    path('password_reset_done/', auth.PasswordResetDoneView.as_view(template_name='user/password_reset_done.html'), name="password_reset_done"),
    ...
    # Change Password
    path('change_password/', auth.PasswordChangeView.as_view(template_name='user/change_password.html', success_url='/'), name="change_password"),
